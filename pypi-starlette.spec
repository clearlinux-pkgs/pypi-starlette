...
Source0  : https://files.pythonhosted.org/packages/ce/20/08dfcd9c983f6a6f4a1000d934b9e6d626cff8d2eeb77a89a68eef20a2b7/starlette-0.46.2.tar.gz
...
%prep
%setup -q -n starlette-0.46.2
cd %{_builddir}/starlette-0.46.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744640954
