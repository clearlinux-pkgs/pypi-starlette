...
Source0  : https://files.pythonhosted.org/packages/13/1c/a0005d1b8e775823b4aa2c4b4ce1b540833c6364ed5de55b6a8754bdc17c/starlette-0.38.0.tar.gz
...
%prep
%setup -q -n starlette-0.38.0
cd %{_builddir}/starlette-0.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721665046
