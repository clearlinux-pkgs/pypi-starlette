...
Source0  : https://files.pythonhosted.org/packages/61/b5/6bceb93ff20bd7ca36e6f7c540581abb18f53130fabb30ba526e26fd819b/starlette-0.37.2.tar.gz
...
%prep
%setup -q -n starlette-0.37.2
cd %{_builddir}/starlette-0.37.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713105780
