...
Source0  : https://files.pythonhosted.org/packages/21/fe/2da6181514acc31a779492172a39d7502fe7b216845cf44d12cd166bfe42/starlette-0.38.1.tar.gz
...
%prep
%setup -q -n starlette-0.38.1
cd %{_builddir}/starlette-0.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721750738
