...
Source0  : https://files.pythonhosted.org/packages/43/e2/d49a94ecb665b3a1c34b40c78165a737abc384fcabc843ccb14a3bd3dc37/starlette-0.38.2.tar.gz
...
%prep
%setup -q -n starlette-0.38.2
cd %{_builddir}/starlette-0.38.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722276614
